...
class Hangman:
    ...
    def __init__(self) -> None:
        ...
        self.lives = 5
        self.correctly_guessed_letters = self.generate_guessed_letters(self.word_to_find)
    ...
    def generate_guessed_letters(self, word: str) -> List[str]:
        """
        Method generating a list of x separate _ characters, with x = length of the string.
        This is used to generate a blank word with stand-ins.
        :param word: a string that needs to be generated a stand-in list for.
        :return: a list of "_" underscores, as long as the string parameter.
        """
        generated_list = []
        while len(generated_list) < len(self.word_to_find):
            generated_list.append('_')
